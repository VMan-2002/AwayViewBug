...
HXLINE(2910)			bool _hx_tmp;
HXDLIN(2910)			if (::hx::IsNotNull( this->stage )) {
HXLINE(2910)				_hx_tmp = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
HXLINE(2910)				_hx_tmp = false;
            			}
HXDLIN(2910)			if (_hx_tmp) {
...
HXLINE(2965)					_hx_tmp = ::hx::IsInstanceNotEq( value,this->_hx___styleSheet );
            				}
            				else {
HXLINE(2965)					_hx_tmp = false;
            				}
...
HXDLIN(3009)			::cpp::VirtualArray this2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(3009)			this1->__SetField(HX_("__tempIndex",3e,e8,54,22),1,::hx::paccDynamic);
HXDLIN(3009)			{
HXLINE(3009)				int _g_current = 0;
HXDLIN(3009)				::cpp::VirtualArray _g_args = this2;
...
HXLINE(3258)				_hx_tmp2 = this->get_selectable();
            			}
            			else {
HXLINE(3258)				_hx_tmp2 = false;
            			}
HXDLIN(3258)			if (_hx_tmp2) {
HXLINE(3258)				_hx_tmp1 = ::hx::IsNotNull( this->stage );
            			}
            			else {
HXLINE(3258)				_hx_tmp1 = false;
            			}
HXDLIN(3258)			if (_hx_tmp1) {
HXLINE(3258)				_hx_tmp = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
HXLINE(3258)				_hx_tmp = false;
            			}
...
HXLINE(3285)				_hx_tmp = !(this->get_displayAsPassword());
            			}
            			else {
HXLINE(3285)				_hx_tmp = false;
            			}
...
HXLINE(3597)					bool _hx_tmp;
HXDLIN(3597)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3597)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3597)						_hx_tmp = false;
            					}
HXDLIN(3597)					if (_hx_tmp) {
HXLINE(3599)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3546)				bool _hx_tmp;
HXDLIN(3546)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3546)					_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3546)					_hx_tmp = false;
            				}
HXDLIN(3546)				if (_hx_tmp) {
HXLINE(3548)					bool _hx_tmp;
HXDLIN(3548)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3548)						_hx_tmp = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3548)						_hx_tmp = false;
            					}
HXDLIN(3548)					if (_hx_tmp) {
HXLINE(3550)						::lime::_hx_system::Clipboard_obj::set_text(this->_hx___text.substring(this->_hx___caretIndex,this->_hx___selectionIndex));
            			...
            			break;
            			case (int)118: {
HXLINE(3572)				bool _hx_tmp;
HXDLIN(3572)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3572)					_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3572)					_hx_tmp = false;
            				}
HXDLIN(3572)				if (_hx_tmp) {
...
HXDLIN(3591)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            			...
            			break;
            			case (int)120: {
HXLINE(3557)				bool _hx_tmp;
HXDLIN(3557)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3557)					_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3557)					_hx_tmp = false;
            				}
HXDLIN(3557)				if (_hx_tmp) {
HXLINE(3559)					bool _hx_tmp;
HXDLIN(3559)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3559)						_hx_tmp = !(this->get_displayAsPassword());
            					}
            					else {
...
HXLINE(3564)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            			...
            			break;
            			case (int)127: {
HXLINE(3424)				bool _hx_tmp;
HXDLIN(3424)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3424)					_hx_tmp = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
HXLINE(3424)					_hx_tmp = false;
            				}
HXDLIN(3424)				if (_hx_tmp) {
...
HXLINE(3511)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
...
HXLINE(3528)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
...
HXLINE(3460)					bool _hx_tmp;
HXDLIN(3460)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3460)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3460)						_hx_tmp = false;
            					}
HXDLIN(3460)					if (_hx_tmp) {
...
HXLINE(3443)					bool _hx_tmp;
HXDLIN(3443)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3443)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3443)						_hx_tmp = false;
            					}
HXDLIN(3443)					if (_hx_tmp) {
...
HXLINE(3477)					bool _hx_tmp;
HXDLIN(3477)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3477)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3477)						_hx_tmp = false;
            					}
HXDLIN(3477)					if (_hx_tmp) {
...
HXLINE(3494)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
...
HXLINE(3387)					 ::openfl::events::TextEvent te =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));
HXLINE(3389)					this->dispatchEvent(te);
HXLINE(3391)					if (!(te->isDefaultPrevented())) {
