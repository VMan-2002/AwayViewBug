...
HXDLIN(  81)				::cpp::VirtualArray this1 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(  81)				textFormatRanges->_hx___tempIndex = 1;
HXDLIN(  81)				{
HXLINE(  81)					int _g_current = 0;
HXDLIN(  81)					::cpp::VirtualArray _g_args = this1;
...
HXLINE(  93)			{
HXLINE(  93)				int deleteCount = textFormatRanges->get_length();
HXDLIN(  93)				::cpp::VirtualArray this1 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(  93)				textFormatRanges->_hx___tempIndex = 0;
HXDLIN(  93)				{
HXLINE(  93)					int _g_current = 0;
HXDLIN(  93)					::cpp::VirtualArray _g_args = this1;
HXDLIN(  93)					while((_g_current < _g_args->get_length())){
HXLINE(  93)						_g_current = (_g_current + 1);
HXDLIN(  93)						 ::Dynamic item = _g_args->__get((_g_current - 1));
HXDLIN(  93)						textFormatRanges->insertAt(textFormatRanges->_hx___tempIndex,( ( ::openfl::text::_internal::TextFormatRange)(item) ));
HXDLIN(  93)						textFormatRanges->_hx___tempIndex++;
            					}
            				}
HXDLIN(  93)				textFormatRanges->splice(textFormatRanges->_hx___tempIndex,deleteCount);
            			}
...
HXLINE( 218)										_hx_tmp = ::hx::IsEq( firstChar,45 );
            									}
            									else {
...
HXLINE( 191)									_hx_tmp = !(noLineBreak);
            								}
            								else {
...
HXLINE( 179)									_hx_tmp = !(noLineBreak);
            								}
            								else {
...
HXLINE( 269)									{
HXLINE( 269)										int _g = 0;
HXDLIN( 269)										while((_g < values->length)){
HXLINE( 269)											::String stop = values->__get(_g);
HXDLIN( 269)											_g = (_g + 1);
