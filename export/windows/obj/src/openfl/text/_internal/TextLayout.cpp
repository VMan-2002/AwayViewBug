...
HXLINE( 154)			 ::Dynamic _hx_tmp = this->_hx___hbBuffer;
HXDLIN( 154)			Float _hx_tmp1 = (uintptr_t)this->text.wc_str();
HXDLIN( 154)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF16(_hx_tmp,_hx_tmp1,this->text.length,0,-1);
...
HXLINE( 162)				_hx_tmp2 = ::hx::IsNotNull( _positions );
            			}
            			else {
...
HXLINE( 174)						{
HXLINE( 174)							int _g1 = (lastCluster + 1);
HXDLIN( 174)							int _g2 = info->cluster;
HXDLIN( 174)							while((_g1 < _g2)){
HXLINE( 174)								_g1 = (_g1 + 1);
HXDLIN( 174)								int j = (_g1 - 1);
HXLINE( 178)								::Array< ::Dynamic> _hx_tmp = this->get_positions();
HXDLIN( 178)								 ::lime::math::Vector2 _hx_tmp1 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 178)								_hx_tmp->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp1, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 181)						::Array< ::Dynamic> _hx_tmp = this->get_positions();
HXDLIN( 181)						int info1 = info->codepoint;
HXDLIN( 181)						 ::lime::math::Vector2 _hx_tmp1 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 181)						_hx_tmp->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp1, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
