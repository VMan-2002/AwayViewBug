...
HXLINE( 869)		 cpp::Int64Struct a = _hx_int64_shr(v,60);
HXDLIN( 869)		sr->f = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct(15))));
HXLINE( 870)		 cpp::Int64Struct a1 = _hx_int64_shr(v,56);
HXDLIN( 870)		sr->m = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct(15))));
HXLINE( 871)		 cpp::Int64Struct a2 = _hx_int64_shr(v,52);
HXDLIN( 871)		sr->w = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct(15))));
HXLINE( 872)		 cpp::Int64Struct a3 = _hx_int64_shr(v,48);
HXDLIN( 872)		sr->s = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct(15))));
HXLINE( 873)		 cpp::Int64Struct a4 = _hx_int64_shr(v,44);
HXDLIN( 873)		sr->d = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct(15))));
HXLINE( 874)		 cpp::Int64Struct a5 = _hx_int64_shr(v,40);
HXDLIN( 874)		sr->t = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct(15))));
HXLINE( 875)		 cpp::Int64Struct a6 = _hx_int64_shr(v,32);
HXDLIN( 875)		sr->type = _hx_int64_low(_hx_int64_and(a6,( ::cpp::Int64Struct(15))));
HXLINE( 876)		 cpp::Int64Struct a7 = _hx_int64_shr(v,16);
HXDLIN( 876)		sr->b = _hx_int64_low(_hx_int64_and(a7,( ::cpp::Int64Struct(255))));
HXLINE( 877)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct(65535))));
