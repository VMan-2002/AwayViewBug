...
HXLINE( 969)				_gthis->copyTo(newLocation,overwrite);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 971)					 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1092)				_gthis->deleteDirectory(deleteDirectoryContents);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE(1094)					 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1163)				_gthis->deleteFile();
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE(1165)					 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1274)				directories = ::sys::FileSystem_obj::readDirectory(_gthis->_hx___path);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE(1276)					 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1544)				_gthis->moveTo(newLocation,overwrite);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE(1546)					 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
