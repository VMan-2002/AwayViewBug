...
HXLINE(1128)				 ::openfl::geom::Matrix _this = this->_hx___getRenderTransform();
HXDLIN(1128)				touchEvent->stageX = (((touchEvent->localX * _this->a) + (touchEvent->localY * _this->c)) + _this->tx);
HXLINE(1129)				 ::openfl::geom::Matrix _this1 = this->_hx___getRenderTransform();
HXDLIN(1129)				touchEvent->stageY = (((touchEvent->localX * _this1->b) + (touchEvent->localY * _this1->d)) + _this1->ty);
            			}
            		}
...
HXLINE(1610)			 ::openfl::geom::Matrix _this = this->_hx___renderTransform;
HXDLIN(1610)			Float norm = ((_this->a * _this->d) - (_this->b * _this->c));
HXDLIN(1610)			Float _hx_tmp;
HXDLIN(1610)			if ((norm == 0)) {
HXLINE(1610)				_hx_tmp = -(_this->tx);
            			}
            			else {
HXLINE(1610)				_hx_tmp = ((((Float)1.0) / norm) * ((_this->c * (_this->ty - global->y)) + (_this->d * (global->x - _this->tx))));
            			}
...
HXLINE(1611)				_hx_tmp1 = -(_this1->ty);
            			}
            			else {
HXLINE(1611)				_hx_tmp1 = ((((Float)1.0) / norm1) * ((_this1->a * (global->y - _this1->ty)) + (_this1->b * (_this1->tx - global->x))));
            			}
...
HXLINE(1626)					_hx_tmp = !(interactiveOnly);
            				}
            				else {
...
HXLINE(1746)				Float _hx_tmp = this->get_alpha();
HXDLIN(1746)				this->_hx___worldAlpha = (_hx_tmp * renderParent->_hx___worldAlpha);
...
HXLINE(1759)					_hx_tmp1 = ::hx::IsEq( this->_hx___blendMode,10 );
            				}
            				else {
HXLINE(1759)					_hx_tmp1 = true;
            				}
...
HXLINE(1820)		bool _hx_tmp5;
HXDLIN(1820)		if (updateChildren) {
HXLINE(1820)			_hx_tmp5 = ::hx::IsNotNull( this->get_mask() );
            		}
            		else {
HXLINE(1820)			_hx_tmp5 = false;
            		}
HXDLIN(1820)		if (_hx_tmp5) {
...
HXLINE(1854)			 ::openfl::geom::Matrix parentTransform = renderParent->_hx___renderTransform;
HXDLIN(1854)			 ::openfl::geom::Matrix target = this->_hx___renderTransform;
HXDLIN(1854)			target->a = ((local->a * parentTransform->a) + (local->b * parentTransform->c));
HXDLIN(1854)			target->b = ((local->a * parentTransform->b) + (local->b * parentTransform->d));
HXDLIN(1854)			target->c = ((local->c * parentTransform->a) + (local->d * parentTransform->c));
HXDLIN(1854)			target->d = ((local->c * parentTransform->b) + (local->d * parentTransform->d));
HXDLIN(1854)			target->tx = (((local->tx * parentTransform->a) + (local->ty * parentTransform->c)) + parentTransform->tx);
HXDLIN(1854)			target->ty = (((local->tx * parentTransform->b) + (local->ty * parentTransform->d)) + parentTransform->ty);
            		}
            		else {
