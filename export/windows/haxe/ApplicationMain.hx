...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AwayViewBug", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("AwayViewBug", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "VMan_2002";
		app.meta["file"] = "AwayViewBug";
		app.meta["name"] = "AwayViewBug";
